...
'-----PART 1------
        ...
        ' This part finds the percentChange, yearChange and conditionally formats the values under yearChange
        ...
        If (ws.Cells(rowCounter - 1, 1).Value = ws.Cells(rowCounter, 1).Value And ws.Cells(rowCounter + 1, 1).Value <> ws.Cells(rowCounter, 1).Value) Then
            ...
            ws.Cells(resultsCounter, 10).NumberFormat = "#.00;(#.00)"
...
'-----PART 2------
        ...
        'This section finds the total volume per ticker
        ...
        If (ws.Cells(rowCounter + 1, 1).Value <> ws.Cells(rowCounter, 1).Value) Then
            ...
            ws.Cells(resultsCounter, 12).NumberFormat = "#,###"
...
'-----PART 3------
    ...
    ' Last part displays the final results section showcasing the greatest increase, greatest decrease, and greatest volume comparison

    ' Initializing values for our loop to compare against
    ...
    For resultsCounter = 2 To lastRow
       ...
       'Autosize columns to make the numbers fit
